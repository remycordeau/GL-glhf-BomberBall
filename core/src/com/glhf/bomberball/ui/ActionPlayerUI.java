...
public class ActionPlayerUI extends Table {
    ...
    public ActionPlayerUI(GameScreen screen){
        ...
        Label move = new Label("Se déplacer",Graphics.GUI.getSkin());
        ...
        Label bomb = new Label("Bombe",Graphics.GUI.getSkin());
        ...
        Label move_mode = new Label("Déplacement",Graphics.GUI.getSkin());
        ...
        Label end_turn = new Label("Fin Tour",Graphics.GUI.getSkin());
    ...
    public class ActionsWidget extends Table {
        public ActionsWidget() {
            TextButton move_L = new TextButton("L", Graphics.GUI.getSkin(), "small");
            TextButton move_R = new TextButton("R", Graphics.GUI.getSkin(), "small");
            TextButton move_U = new TextButton("U", Graphics.GUI.getSkin(), "small");
            TextButton move_D = new TextButton("D", Graphics.GUI.getSkin(), "small");
